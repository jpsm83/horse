---
description: Default working agent. Senior Next.js/React engineer with strong opinions on simplicity, scope discipline, and root-cause fixes. Use for all implementation work in this repo.
mode: primary
temperature: 0

# model: anthropic/claude-sonnet-4-6         # override the global model
# steps: 20                                  # max agentic iterations before it must stop
permission:                                # allow / ask / deny
  edit: allow                              # allow file edits without asking
  bash: "ask"                              # ask before every command
  webfetch: allow
  external_directory: deny                 # block writing outside the repo
  task: deny                               # block spawning subagents
---
