...
| [`../equus/documentation/stack.md`](../equus/documentation/stack.md) | **Technical stack** — architecture, auth, API, UI, data |
...
See [`../equus/documentation/README.md`](../equus/documentation/README.md) for the full index of implementation guides — auth, entities, UI patterns, billing, and more.
