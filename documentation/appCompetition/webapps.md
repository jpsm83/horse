...
| **Role in Equus strategy** | Match EquineM barn operations in `stableModule.md`; exceed with horse-centric ecosystem (owners pay, businesses free, consent-based network) — see `businessPlan.md` §20 |
...
- Clear Equus **parity checklist** source (`stableModule.md` Parity: EquineM rows)
