...
vi.mock("@/lib/theme/appTheme.ts", () => ({
  themeSwatches: {
    default: ["#212226", "#2a3b42", "#445a4d", "#b8520a", "#779e7f"],
    onyx: ["#111111", "#1a1a1a", "#2a2a2a", "#8b8b8b", "#4a4a4a"],
  },
  normalizeTheme: (theme?: string) => (theme === "onyx" ? "onyx" : "default"),
  applyThemeToDocument: vi.fn(),
  syncThemeCookie: vi.fn(),
  THEME_COOKIE_NAME: "EQUUS_THEME",
  themeHtmlClass: (theme: string) => (theme === "onyx" ? "theme-onyx" : ""),
}));
