 ...
 * `HorseSelectField` (shadcn Select), with multi-value selection.
 */
...
type HorseMultiSelectFieldProps = {
  id: string;
  label: string;
  value: string[];
...
export function HorseMultiSelectField({
  id,
  label,
  value,
  onChange,
