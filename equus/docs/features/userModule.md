...
- [equus/docs/product/businessPlan.md](../product/businessPlan.md) — vision, Section 10.1 User module, multi-role model, discovery rules; Section 15 utility-first social
...
- [equus/docs/product/productFlows.md](../product/productFlows.md) — onboarding journeys
- [equus/docs/engineering/stack.md](../engineering/stack.md) — technical stack and API layout
- [equus/docs/engineering/profile.md](../engineering/profile.md) — profile page UI and `PATCH /api/v1/users/me`
- [equus/docs/engineering/userAuthTodo.md](../engineering/userAuthTodo.md) — **execution checklist** for user/auth gaps not yet implemented (audit 2026-06-30)
...
Per-role discovery API detail lives in [`equus/docs/engineering/`](../engineering/) (e.g. `equus/docs/engineering/entities/horses.md`, `equus/docs/engineering/entities/stables.md`, `equus/docs/engineering/entities/trainers.md`). Horse-module features live in [`horseModule.md`](horseModule.md); do not duplicate those tables here.
...
Horse discovery (`Horse.profileVisibility`, `Horse.contactDisplay`) is documented in [`horseModule.md`](horseModule.md) §3 and [equus/docs/engineering/entities/horses.md](../engineering/entities/horses.md).
...
|------|-----------|---------------|--------------|
| Horse | Entity | [equus/docs/engineering/entities/horses.md](../engineering/entities/horses.md) | `POST` / `PATCH …/discovery` / `GET` — done |
| Stable | Entity | [equus/docs/engineering/entities/stables.md](../engineering/entities/stables.md) | done |
| Breeder | Entity | [equus/docs/engineering/entities/breeders.md](../engineering/entities/breeders.md) | done |
| Transport | Entity | [equus/docs/engineering/entities/transports.md](../engineering/entities/transports.md) | done |
| Trainer | User-linked | [equus/docs/engineering/entities/trainers.md](../engineering/entities/trainers.md) | done |
| Groom | User-linked | [equus/docs/engineering/entities/grooms.md](../engineering/entities/grooms.md) | done |
| Veterinary | User-linked | [equus/docs/engineering/entities/veterinaries.md](../engineering/entities/veterinaries.md) | done |
| Coach | User-linked | [equus/docs/engineering/entities/coaches.md](../engineering/entities/coaches.md) | done |
| Farrier | User-linked | [equus/docs/engineering/entities/farriers.md](../engineering/entities/farriers.md) | done |
| Rider | User-linked | [equus/docs/engineering/entities/riders.md](../engineering/entities/riders.md) | done |
| Riding club | Entity | [equus/docs/engineering/entities/riding-clubs.md](../engineering/entities/riding-clubs.md) | done |
...
**Priority for first delivery:** user identity details and interaction surfaces that support **horse/stable social utility** — discovery drill-down, chat, care-network participation — without a people search directory or open social network (`equus/docs/product/businessPlan.md` §15; entity-first discovery remains locked).
