...
**Status:** **drift** (profile/discovery only; no roster/ops/good-standing)  
...
Gate writes on good standing ([`billing.md`](billing.md)). Barn-created boarded horse → waiting-transfer on the horse ([`horses.md`](horses.md) Target).
