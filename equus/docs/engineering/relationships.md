...
Consent and lifecycle links between a **horse** and a **provider** role profile (`Relationship` collection). Distinct from **workplace collaboration** (`WorkplaceRelationship`) — see [equus/docs/features/workplaceRelationship.md](../features/workplaceRelationship.md).

Product flows: [equus/docs/product/productFlows.md](../product/productFlows.md) Flow 6.
