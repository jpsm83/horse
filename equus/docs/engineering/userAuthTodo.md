...
Living checklist derived from [equus/docs/features/userModule.md](../features/userModule.md) (2026-06-30), cross-checked against `equus/` implementation.
...
**Data lifecycle:** [equus/docs/features/dataLifecycle.md](../features/dataLifecycle.md) — no hard deletes; tombstone fields on models; status enums on links.

**Ownership spec:** [equus/docs/features/ownershipTransfer.md](../features/ownershipTransfer.md) — `transfer_main`, `remove_co_owner`, `promote_co_owner`; entity-owned only (horse + host businesses); never services.
...
| ID | Task | Why | Touch |
|----|------|-----|-------|
| UA-00 | `[x]` **Document data lifecycle policy** — no hard deletes; tombstone vs status lifecycle | Team rule for referential integrity across modules | `equus/docs/features/dataLifecycle.md`, `./dataLifecycle.md`, `equus/docs/features/userModule.md` §principles, `../AGENTS.md` |
...
| UA-09 | `[x]` **Update userModule** — mark U-PRIV-05 `in progress` → `done`; document `GET /users/:id` | Keep spec in sync | `equus/docs/features/userModule.md` |
...
| UA-11 | `[x]` **Document account deactivation** — U-PROF-07 in userModule; profile.md + dataLifecycle.md | Shipped with UA-10 UI | `equus/docs/features/userModule.md`, `./profile.md` |
...
Product rules: [equus/docs/features/ownershipTransfer.md](../features/ownershipTransfer.md). API sketch: [`./ownershipTransfer.md`](ownershipTransfer.md).
...
| 2026-06-30 | OwnershipTransfer tasks (UA-13–22) per [equus/docs/features/ownershipTransfer.md](../features/ownershipTransfer.md) |
