...
Consent-based changes to `mainOwnerUserId` and `coOwners[]` on **entity-owned** profiles (`Horse`, `Stable`, `Breeder`, `Transport`, `RidingClub`). Product rules: [equus/docs/features/ownershipTransfer.md](../features/ownershipTransfer.md).
...
- Horse billing after `transfer_main`: [equus/docs/features/horseModule.md](../features/horseModule.md) H-BILL-03
- Stable operator context: [equus/docs/features/stableModule.md](../features/stableModule.md)
