...
Related:
- [equus/docs/features/userModule.md](../../features/userModule.md) — competition coach vs barn collaborator paths
- [equus/docs/features/workplaceRelationship.md](../../features/workplaceRelationship.md) — coach as stable collaborator (with trainer)
- [`horses.md`](horses.md)
