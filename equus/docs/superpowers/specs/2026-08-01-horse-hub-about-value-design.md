...
| File | Change |
|------|--------|
| `equus/docs/engineering/entities/horses.md` | Remove "not Hub-facing" for value/proactive/coOwner; update Hub tree (About = description; Value replaces Description); clarify L1 vs tabs vs L2; Hub-facing cheap keys list. |
| `equus/docs/engineering/horseTabs.md` | Same Hub tree + visibility note. |
| `equus/docs/engineering/page-flow-blueprint.md` | Hub-facing keys list; same three-control wording. |
