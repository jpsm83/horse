...
> **SUPERSEDED** by `equus/docs/superpowers/specs/2026-07-24-color-token-centralization-completion-design.md`. Keep for history only — do not implement from this document.
