...
**Status:** Approved  
**Supersedes:** `equus/docs/superpowers/specs/2025-07-19-color-token-centralization-design.md` and `equus/docs/superpowers/plans/2025-07-19-color-token-centralization.md`
...
5. **Tracking:** implementation plan with checkboxes at  
   `equus/docs/superpowers/plans/2026-07-24-color-token-centralization-completion.md`.
...
|----------|-------------|
| `equus/docs/superpowers/specs/2025-07-19-color-token-centralization-design.md` | Superseded — historical baseline only |
| `equus/docs/superpowers/plans/2025-07-19-color-token-centralization.md` | Superseded — do not execute; use 2026-07-24 plan |
