...
**Files:**
- Modify: `equus/docs/engineering/horseTabs.md` — update tab definitions with role info
- Modify: `equus/docs/features/horseModule.md` (if exists) — document new role
- Modify: `equus/docs/features/ownershipTransfer.md` — document new transfer kinds
- Modify: `equus/docs/engineering/ownershipTransfer.md` — document new transfer kinds

- [ ] **Step 1: Update equus/docs/engineering/horseTabs.md with role-based visibility changes**
