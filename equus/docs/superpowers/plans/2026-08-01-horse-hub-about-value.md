...
Run: `rg -n "HorseHubDescription|horse-hub-description" equus/app equus/components equus/docs`
...
**Files:**
- Modify: `equus/docs/engineering/entities/horses.md`
...
- [ ] **Step 1: Update `equus/docs/engineering/entities/horses.md`**

In `equus/docs/engineering/entities/horses.md`:
...
- [ ] **Step 2: Update `equus/docs/engineering/horseTabs.md`**

In `equus/docs/engineering/horseTabs.md`:
...
- [ ] **Step 3: Update `equus/docs/engineering/page-flow-blueprint.md`**

In `equus/docs/engineering/page-flow-blueprint.md` line 276, replace:
```
...
Run: `rg -n "not Hub-facing|Admin-only keys|HorseHubDescription|horse-hub-description|Hub description" equus/docs equus/AGENTS.md`
Expected: no matches (or only legitimately unrelated "Admin-only" phrasing).

- [ ] **Step 6: Commit**

```bash
git add equus/docs/engineering/entities/horses.md equus/docs/engineering/horseTabs.md equus/docs/engineering/page-flow-blueprint.md equus/AGENTS.md
