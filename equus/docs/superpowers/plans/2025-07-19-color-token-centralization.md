...
> **SUPERSEDED** by the plan that will accompany `equus/docs/superpowers/specs/2026-07-24-color-token-centralization-completion-design.md` (`equus/docs/superpowers/plans/2026-07-24-color-token-centralization-completion.md`). Do not execute this plan.
