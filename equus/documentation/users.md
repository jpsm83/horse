...
Reference for the user hub and its visibility model. Mirrors `horses.md` for the user entity.
...
- [`../../documentation/userModule.md`](../../documentation/userModule.md) — user module spec (U-PRIV-05)
