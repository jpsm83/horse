...
describe("stableService", () => {
  ...
  it("returns a guest view with business contact for a public stable", async () => {
    ...
    expect(view.stable.tradeName).toBe("Public Stable");
