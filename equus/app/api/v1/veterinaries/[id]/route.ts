/**
 * Veterinary card + owner profile routes.
 *
 * `GET`   `/api/v1/veterinaries/[id]` — public veterinary card.
...
export async function GET(request: Request, context: RouteContext) {
  return withRoute(async () => {
    ...
    const veterinary = await veterinaryService.getPublicVeterinaryCard(id, requester);
